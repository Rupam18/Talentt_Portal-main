...
function CameraCornerPreview() {
  ...
  return (
    <div className="camera-corner-preview">
      ...
      {/* Multiple Face Detection Modal */}
      <Modal 
        show={showMultiFaceModal} 
        onHide={() => setShowMultiFaceModal(false)}
        centered
        backdrop="static"
        keyboard={false}
      ...
      >
        <Modal.Body className="text-center p-5">
          <div className="modal-icon mb-4">⚠️</div>
          <h2 className="modal-title">Multiple Faces Detected</h2>
          <p className="modal-description">
            Multiple faces have been detected in the camera frame. 
            Please ensure only the registered candidate is visible during the test.
          </p>
          <div className="modal-info">
            <div className="info-item">
              <span style={{ color: '#ef4444', fontWeight: 'bold' }}>Faces Detected: {detectedFaceCount}</span>
            </div>
          </div>
          <Button
            variant="warning"
